        ...
        (n.n = function (e) {
            ...
            (function () {
                ...
                const m = function (e, t) {
                    ...
                    b = (e, t) => {
                        let r;
                        return (e = g(e)), t && (Array.isArray(t) ? (r = A(t.join(" "))) : ("boolean" == typeof t && (t = t.toString()), (r = A(t.trim())))), { name: e, value: (t = t ? `="${r}"` : "") };
                    },
                    g = (e) => ({ className: "class" }[e] || y(e)),
                    y = (e) =>
                    ...
                    k = (e) => {
                        ...
                        for (let r = 0; r < e.length; r++) {
                            const n = f(f({}, j(e[r])), {}, { label: e[r].textContent });
                            t.push(n);
                        }
                        return t;
                    },
                    ...
                    D = (e, t) => {
                        ...
                        for (const n in t) r.hasOwnProperty(n) && (Array.isArray(t[n]) ? (r[n] = Array.isArray(e[n]) ? L(e[n].concat(t[n])) : t[n]) : "object" == typeof t[n] ? (r[n] = D(e[n], t[n])) : (r[n] = t[n]));
                        return r;
                    },
                    q = /^col-(xs|sm|md|lg)-([^\s]+)/,
                    M = {
                ...
                class I {
                    constructor(e, t) {
                        ...
                        (this.classConfig = jQuery.extend({}, I.controlConfig[n] || {})),
                    ...
                    on(e) {
                        const t = {
                            ...
                            render: (e) => {
                                ...
                                this.css && N(this.css), this.js && !P(this.js) ? R(this.js).done(t) : t();
                            },
                        };
                        return e ? t[e] : t;
                    }
                ...
                class _ {
                    constructor(e, t, r, n) {
                        ...
                        void 0 === t && (t = !1),
                            void 0 === r && (r = !1),
                            void 0 === n && (n = {}),
                            (this.preview = null !== (o = t) && void 0 !== o && o),
                            (this.disableHTMLLabels = null !== (i = r) && void 0 !== i && i),
                            (this.controlConfig = null !== (s = n) && void 0 !== s ? s : {}),
                            (this.templates = {
                                label: null,
                                help: null,
                                default: (e, t, r, n) => (r && t.appendChild(r), this.markup("div", [t, e], { className: U(n, e) })),
                                noLabel: (e, t, r, n) => this.markup("div", e, { className: U(n, e) }),
                                hidden: (e) => e,
                            }),
                    ...
                    configure() {}
                    build(e, t, r) {
                        this.preview && (t.name ? (t.name = t.name + "-preview") : (t.name = F.nameAttr(t) + "-preview")), (t.id = t.name), (this.data = jQuery.extend({}, t)), (I.controlConfig = this.controlConfig);
                ...
                I.register("button", Q), I.register(["button", "submit", "reset"], Q, "button");
                class X extends I {
                    constructor(e, t, r) {
                ...
                class J extends I {
                    build() {
                        ...
                        return o[t] && (n = o[t]), { field: this.markup(n, F.parsedHtml(this.label), r), layout: "noLabel" };
                    }
                }
                I.register(["paragraph", "header"], J), I.register(["p", "address", "blockquote", "canvas", "output"], J, "paragraph"), I.register(["h1", "h2", "h3", "h4", "h5", "h6"], J, "header");
                ...
                I.register(
                    ...
                    class extends I {
                        ...
                        build() {
                            ...
                            return (this.dom = "select" == i ? this.markup(c, e, m(d, !0)) : this.markup("div", e, { className: i })), this.dom;
                        }
                        groupRequired() {
                ...
                I.register(["text", "file", "date", "number"], Y),
                    I.register(["text", "password", "email", "color", "tel"], Y, "text"),
                    I.register(["date", "time", "datetime-local"], Y, "date"),
                    I.register(["number", "range"], Y, "number");
                const ee = ["value"];
                class te extends I {
                    static get definition() {
                ...
                I.register("textarea", te), I.register("textarea", te, "textarea");
                const re = ["value"];
                te.register(
                    "tinymce",
                    class extends te {
                        configure() {
                            if (((this.js = []), window.tinymce || this.js.push("./tinymce.min.js"), this.classConfig.js)) {
                        ...
                        onRender() {
                            ...
                            const i = function (e) {
                                o ? e.setContent(o) : n && e.setContent(n);
                            };
                            setTimeout(() => {
                ...
                te.register(
                    ...
                    class extends te {
                        configure() {
                            ...
                            Object.assign(this, ie(ie({}, { js: "./quill.js", css: "./quill.snow.css" }), t)), (this.editorConfig = ie(ie({}, e), r));
                        }
                        build() {
                            const e = this.config,
                                { value: t = "" } = e,
                ...
                class ae {
                    ...
                    register(e, t) {
                        ...
                        Object.keys(e).forEach((t) => {
                            const r = function (r, n) {
                                (this.customControl = new X(r, n, e[t])),
                                    (this.build = function () {
                        ...
                        for (const r of t) {
                            ...
                            if (e[t]) {
                                ...
                                (e.definition = r), (this.customRegister[o] = jQuery.extend(r, { type: t, class: e }));
                            } else {
                                const e = I.getClass(t, r.subtype);
                                if (!e) {
                                ...
                                (o = r.datatype ? r.datatype : `${t}-${Math.floor(9e3 * Math.random() + 1e3)}`), (this.customRegister[o] = jQuery.extend(r, { type: t, class: e }));
                            }
                    ...
                    label(e) {
                        ...
                        if (i) return i;
                        let s = t.mi18n;
                        return "object" == typeof s && (s = s[o] || s[e]), s || (s = o), r().get(s);
                    }
                    get definition() {
                        return {};
                    }
                ...
                class le {
                    constructor(e) {
                        ...
                        (this.options = jQuery.extend(!0, t, e)),
                            ...
                            (this.templatedControls = new ae(this.options.templates)),
                            "function" != typeof Element.prototype.appendFormFields &&
                                (Element.prototype.appendFormFields = function (e) {
                                    Array.isArray(e) || (e = [e]);
                                    const t = F.markup("div", e, { className: "rendered-form formbuilder-embedded-bootstrap" });
                                    this.appendChild(t),
                                        e.forEach((e) => {
                                            ...
                                            if (r) {
                                                ...
                                                o || ((o = F.markup("div", null, { id: n, className: "row" })), t.appendChild(o)), o.appendChild(e);
                    ...
                    sanitizeField(e, t) {
                        ...
                        return (
                            ...
                            (r.className = Array.isArray(e.className) ? F.unique(e.className.join(" ").split(" ")).join(" ") : e.className || e.class || null),
                            delete r.class,
                            e.values && (e.values = e.values.map((e) => F.trimObj(e))),
                            F.trimObj(r)
                        );
                    }
                    getElement(e) {
                    ...
                    parseFormData(e) {
                        const t = { xml: (e) => E(e), json: (e) => window.JSON.parse(e) };
